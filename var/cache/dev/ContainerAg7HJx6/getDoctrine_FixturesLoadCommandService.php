...
include_once $this->targetDirs[3].'/src/DataFixtures/MyUserFixture.php';
...
$a->addFixtures(array(0 => new \App\DataFixtures\MyUserFixture(($this->services['security.password_encoder'] ?? $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php')))));
